# Generated by Django 5.2 on 2025-12-13 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('normal', 'Normal User'), ('transitor', 'Transtor'), ('tax_worker', 'Tax Worker'), ('instructor', 'Instructor')], max_length=20)),
        ...
        migrations.CreateModel(
            name='TaxWorkerProfile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_title', models.CharField(max_length=100)),
                ('work_email', models.EmailField(max_length=254)),
                ('company_id_card', models.FileField(blank=True, null=True, upload_to='company_ids/')),
